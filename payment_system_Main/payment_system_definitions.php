<?php
  define("COMPANY_CODE", "Company(code)"); // Company code
  ...
  //define('VISMA_LIBRARY_LOCATION', '/vendor/visma-pay/visma-pay/lib/visma_pay_loader.php'); // Visma loader location in Visma Library structure
